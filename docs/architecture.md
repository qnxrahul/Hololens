...
- S3-compatible object storage (MinIO, Ceph RGW) for session artifacts, recorded frames, and exported reports.
- Presigned URLs generated by the agent for secure, time-limited access to media files.
